...
import 'package:citygrow/UI/HomeUIComponent/ChatItem.dart';
import 'package:citygrow/UI/CartUIComponent/Delivery.dart';

import 'package:flutter_rating/flutter_rating.dart';
import 'package:citygrow/UI/HomeUIComponent/ReviewLayout.dart';
...
class DetailProductAll extends StatefulWidget {
  ...
  final int index;
  DetailProductAll({this.productApiCall, this.index});

  @override
  _DetailProductAllState createState() =>
      _DetailProductAllState(productApiCall: productApiCall, index: index);
}
...
class _DetailProductAllState extends State<DetailProductAll> {
  ...
  final ProductApiCall productApiCall;
  final int index;
  _DetailProductAllState({this.productApiCall, this.index});
                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                            productApiNotifier.productList[index].description,
                            style: _detailText),
                      ),
                      Padding(
