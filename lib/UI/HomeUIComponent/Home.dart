...
import 'package:citygrow/Library/carousel_pro/carousel_pro.dart';
import 'package:flutter/material.dart';
import 'package:citygrow/ListItem/HomeGridItemRecomended.dart';
import 'package:citygrow/UI/HomeUIComponent/AppbarGradient.dart';
import 'package:citygrow/Library/countdown/countdown.dart';
import 'package:citygrow/UI/HomeUIComponent/CategoryDetail.dart';
import 'package:citygrow/UI/HomeUIComponent/DetailProduct.dart';
import 'package:citygrow/UI/HomeUIComponent/FlashSale.dart';
import 'package:citygrow/UI/HomeUIComponent/MenuDetail.dart';
import 'package:citygrow/UI/HomeUIComponent/PromotionDetail.dart';
...
class _MenuState extends State<Menu> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    var imageSlider = Container(
      ...
      child: new Carousel(
        boxFit: BoxFit.cover,
        dotColor: Color(0xFF8f94fb).withOpacity(0.8),
        dotSize: 5.5,
        dotSpacing: 16.0,
...
class ItemGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(PageRouteBuilder(
            pageBuilder: (_, __, ___) => new DetailProductAll(productApiCall: productApiCall,index: index,),
