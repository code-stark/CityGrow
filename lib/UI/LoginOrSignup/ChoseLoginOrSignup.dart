...
import 'package:citygrow/UI/LoginOrSignup/Login.dart';
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Center(
                                  /// Animation text CityGrow shop accept from splashscreen layout (Click to open code)
                                  child: Hero(
                                    tag: "CityGrow",
                                    child: Text(
                                      "CityGrow Shop",
                                ...
                                /// Padding Text "Get best product in CityGrow shop" (Click to open code)
                                Padding(
                                    padding: EdgeInsets.only(
                                        left: 160.0,
                                        right: 160.0,
                                ...
                                Text(
                                  "Get best product in CityGrow shop",
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 17.0,
